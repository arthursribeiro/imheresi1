...
public class ErroCadastro extends JFrame {

    private JButton botaoOK;
    private JLabel erroLabel;
	private static ErroCadastro instanciaUnica;
    ...
    public static ErroCadastro getInstancia(){
    	if(instanciaUnica == null) instanciaUnica = new ErroCadastro();
